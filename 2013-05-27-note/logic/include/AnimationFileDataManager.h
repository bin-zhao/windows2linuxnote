#ifndef  _NINJIATRIBE_ANIMATIONFILEDATAMANAGER_H_
#define  _NINJIATRIBE_ANIMATIONFILEDATAMANAGER_H_
...
{
public:
	std::map<std::string, AnimationFileData*> m_AnimationFileList;
