#ifndef  _NINJIATRIBE_LOCALNOTIFICATIONDATAMANAGER_H_
#define  _NINJIATRIBE_LOCALNOTIFICATIONDATAMANAGER_H_
...
public:
	...
	char mNotifyTextCN[128];    // 提示文字
	char mNotifyTextEN[128];    // 提示文字
