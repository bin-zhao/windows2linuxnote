...
bool VariableSystem::Init()
{
	...
	do
	{
		...
		int type = EngineSystem::GetDeviceType();
		if (type == EngineSystem::_TYPED_IOS_DEVICE_ANDROID_)
		{
			file = "resource/config/system_iphone.xml";
		}
		else if (type == EngineSystem::_TYPED_IOS_DEVICE_IPHONE_)
		{
			file = "resource/config/system_iphone.xml";
		}
		else if (type == EngineSystem::_TYPED_IOS_DEVICE_IPAD_)
		{
			file = "resource/config/system.xml";
		}
