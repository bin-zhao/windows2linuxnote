...
public:
    ...
    */
	...
	/**
    @brief    The function be called when the application surface created on android
    @interval       the pointer of the application
    */
    virtual void applicationAndroidSurfaceCreated() = 0;
